...
class HomePage {
  ...
  downloadFirstImageCarousel () {
    return this.firstImageCarousel().then((response) => {
      cy.writeFile(localPath.firstImageCarousel, response.body, 'binary')
    })
  }

  downloadSecondImageCarousel () {
    return this.secondImageCarousel().then((response) => {
      cy.writeFile(localPath.secondImageCarousel, response.body, 'binary')
    })
  }

  downloadThirdImageCarousel () {
    return this.thirdImageCarousel().then((response) => {
